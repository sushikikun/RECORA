...
Customer Measurement DB measured-result source readiness is audited in `docs/recora-customer-measurement-db-readiness-audit.md`; report data work should continue to separate measured source evidence from published customer snapshots.
Daily batch measurement, plan/model limits, publication, rerun, answer visibility, and recommendation publishing decisions are recorded in `docs/recora-operational-db-completion-plan.md`.
