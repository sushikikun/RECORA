...
| P4-B: account, invitation, membership, derived access | 2 | Auth-adjacent server commands and derived access using P4-A/Phase 3. | Depends on P4-A; no migration and no P4-C contract/billing file edits. No final UI/registration decision. |
