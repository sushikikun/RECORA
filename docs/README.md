...
| [`recora-customer-lifecycle-account-contract-billing.md`](./recora-customer-lifecycle-account-contract-billing.md) | **Phase 4 customer lifecycle / account / contract / billing proposal** — Stage 1 planning baseline; preserves Phase 3 lifecycle, membership, entitlement, and data-retention authority while deferring commercial product decisions to Human review. |
