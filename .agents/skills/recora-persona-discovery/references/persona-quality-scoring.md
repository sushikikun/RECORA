...
Use this together with `evidence-to-persona-traceability.md`, `icp-anti-icp-fit.md`, `persona-research-question-generator.md`, and `persona-confidence-upgrade-data.md`. A persona can score well strategically and still be held out of normal handoff when traceability, ICP fit, validation questions, or confidence-upgrade data are missing.
