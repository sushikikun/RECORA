...
replace_once(
    VERIFY,
    'import { normalizeRecoraPromptGenerationInput } from '
    '"../lib/recora/prompt-generation-input-normalizer";\n'
    'import {',
    'import { normalizeRecoraPromptGenerationInput } from '
    '"../lib/recora/prompt-generation-input-normalizer";\n'
    'import { RECORA_PERSONA_SELECTION_RECIPES_V3 } from '
    '"../lib/recora/measurement-persona-selection-rules";\n'
    'import {'
)
...
audience_doc = '''## Audience別Fallbackと複合Recipe
